...
<body>
    ...
    <script>
        const apiUrl = 'http://192.168.132.209/expresso-cafe/api/users/login'; // Login API URL
        const orderStatusApiUrl = 'http://192.168.132.209/expresso-cafe/api/orders/search-by-reference-number'; // Order status API URL
        const notificationsApiUrl = 'http://192.168.132.209/expresso-cafe/api/notifications'; // Notifications API URL
        const wsUrl = 'ws://192.168.132.209:8080'; // WebSocket server URL
